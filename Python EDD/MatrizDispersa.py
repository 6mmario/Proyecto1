...
class MatrizDispersa:
                ...
                while temp != None:
                    if temp.ao == ao and temp.genero == genero:
                        if temp.date > date:
                            newdate = temp.date
                            temp.date = date
                            new = Nodo(ao, genero, newdate, self.contador5)
                            ...
                            if temp.siguiente == None:
                                ...
                                if temp.siguiente.date > newdate:
    ...
    def Grafica(self):
        ...
        g.attr('node', shape='box', style='filled, rounded', width='1.1', height="1,1", fillcolor='azure1',
               color='blue')
        ...
        while aux2 != None:
            g.body.append(
                'nodo' + str(aux2.nodo) + " ->" + "nodo" + str(aux2.abajo.nodo) + '[constraint=false, dir="both"]')
            #  g.body.append('nodo' + str(aux2.abajo.nodo) + "->" + "nodo" + str(aux2.nodo)+'')
            temp = aux2.abajo
            while temp.abajo != None:
                g.body.append(
                    'nodo' + str(temp.nodo) + " ->" + "nodo" + str(temp.abajo.nodo) + '[constraint=false, dir="both"]')
